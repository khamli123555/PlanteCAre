...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        if (isset($_FILES['photo']) && $_FILES['photo']['error'] == 0) {
            ...
            // Vérification de la tailleresoudre 
            ...
            if (!move_uploaded_file($_FILES['photo']['tmp_name'], $destination)) {
                throw new Exception("Erreur lors de l'upload de l'image. Vérifiez les permissions du dossier.");
            }
        ...
        $stmt = $conn->prepare("INSERT INTO Plante (nom, type, besoins_eau, besoins_lumière, date_plantation, 
                remarques, photo, id_utilisateur) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
        ...
        $_SESSION['success_message'] = "La plante a été ajoutée avec succès !";
...
<head>
    ...
    <title>Ajouter une Plante - PlantCare</title>
    ...
    <style>
        ...
        @keyframes gridMove {
            ...
            50% {
                transform: perspective(500px) rotateX(60deg) translateX(10px);
            }
            100% {
                transform: perspective(500px) rotateX(60deg) translateX(0);
            }
        ...
        <div class="container py-5">
            ...
            <div class="form-container">
                <div class="page-title">
                    <i class="fas fa-seedling me-2"></i>Ajouter une plante
                </div>
                ...
                <form method="POST" enctype="multipart/form-data" id="plantForm">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" name="remarques" rows="4" 
                                  placeholder="Notes supplémentaires sur votre plante..."></textarea>
                    </div>
